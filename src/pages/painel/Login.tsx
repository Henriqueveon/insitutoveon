    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 flex items-center justify-center p-4">
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="mt-4 text-2xl font-bold text-white">Painel do Gestor</h1>
          <p className="text-slate-400 mt-2">Acesse sua conta para gerenciar candidatos</p>
        </div>
        ...
        <Card className="bg-slate-800/50 border-slate-700 backdrop-blur-sm">
          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <Button
                type="submit"
                className="w-full bg-gradient-to-r from-[#00D9FF] to-[#0099CC] hover:from-[#00C4E6] hover:to-[#0088B3] text-white font-semibold"
                disabled={isLoading}
              >
                {isLoading ? (
                  <>
